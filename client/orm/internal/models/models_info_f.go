...
import (
	...
	"github.com/brotherbui/beego/v2/client/orm/internal/utils"
)
...
checkType:
	...
	case Fielder:
		...
		if fieldType&IsRelField > 0 {
			err = fmt.Errorf("unsupport type custom field, please refer to https://github.com/brotherbui/beego/v2/blob/master/orm/models_fields.go#L24-L42")
			goto end
		}
	default:
		tag = "rel"
